				...
				<ul class="navbar-nav align-items-center d-none d-md-flex">
					<li class="nav-item dropdown"><a class="nav-link pr-0"
						...
						<div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
							...
							<a href="Login.jsp" class="dropdown-item"> <i class="ni ni-user-run"></i>
								<span>Logout</span>
							</a>
						</div></li>
				</ul>
							...
							<form action="myprofile" method="post">
										...
										<div class="col-lg-6">
											<div class="form-group focused">
												<label class="form-control-label" for="input-last-name">Mobile
													...
													class="form-control form-control-alternative" name="mobile"
								...
								<div class="pl-lg-4">
									<div class="form-group focused">
										...
										<textarea rows="4"
											class="form-control form-control-alternative"
											placeholder="A few words about you ...">A beautiful Dashboard created by manish parashar.</textarea>
									</div>
								</div>
								<div class="col-4 text-right">
									<button type="submit" name="edit" value="edit" class="btn btn-sm btn-primary">save changes</button>
								</div>
							</form>
						</div>
					</div>
				...
				<div class="copyright">
					<p>
						Made with <a
							...
							target="_blank">manish Dashboard</a> by Creative programmer
					</p>
				</div>
			</div>
		</div>
